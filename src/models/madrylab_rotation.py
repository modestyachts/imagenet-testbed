...
model_params = {
'resnet18-rotation-nocrop_40': {    'arch': 'resnet18',
                                    'eval_batch_size': 256,
                                    'img_crop_size': 224,
                                    'img_resize_size': 256,
                                    'input_space': 'RGB',
...
'resnet18-rotation-random_30': {    'arch': 'resnet18',
                                    'eval_batch_size': 256,
                                    'img_crop_size': 224,
                                    'img_resize_size': 256,
                                    'input_space': 'RGB',
                                    'mean': [0.485, 0.456, 0.406],
                                    'std': [0.229, 0.224, 0.225]},
'resnet18-rotation-random_40': {    'arch': 'resnet18',
                                    'eval_batch_size': 256,
                                    'img_crop_size': 224,
                                    'img_resize_size': 256,
                                    'input_space': 'RGB',
                                    'mean': [0.485, 0.456, 0.406],
                                    'std': [0.229, 0.224, 0.225]},
'resnet18-rotation-standard_40': {  'arch': 'resnet18',
                                    'eval_batch_size': 256,
                                    'img_crop_size': 224,
                                    'img_resize_size': 256,
                                    'input_space': 'RGB',
                                    'mean': [0.485, 0.456, 0.406],
                                    'std': [0.229, 0.224, 0.225]},
'resnet18-rotation-worst10_30': {   'arch': 'resnet18',
                                    'eval_batch_size': 256,
                                    'img_crop_size': 224,
                                    'img_resize_size': 256,
                                    'input_space': 'RGB',
                                    'mean': [0.485, 0.456, 0.406],
                                    'std': [0.229, 0.224, 0.225]},
'resnet18-rotation-worst10_40': {   'arch': 'resnet18',
                                    'eval_batch_size': 256,
                                    'img_crop_size': 224,
                                    'img_resize_size': 256,
                                    'input_space': 'RGB',
